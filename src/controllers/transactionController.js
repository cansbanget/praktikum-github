    ...
    createTransaction: async (req, res) => {
        ...
        try {
            ...
            for (const item of items) {
                ...
                processedItems.push({ productId: product.id, quantity: item.quantity, pricePerItem: product.price, stock: product.stock });
            }
            ...
            for (const item of processedItems) {
               ...
               // await ProductModel.update(item.productId, null, null, null, item.stock - item.quantity, null); // Hanya update stock
            }
